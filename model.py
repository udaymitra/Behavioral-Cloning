...
from keras.layers import Conv2D, Dense, MaxPooling2D, Dropout, Flatten, ELU, Convolution2D
...
def main(_):
    ...
    model = model_reader.read_model(FLAGS.model) if FLAGS.model else getNvidiaModel()
